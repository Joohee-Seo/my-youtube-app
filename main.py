...
유튜브 댓글 분석 앱 - 1단계
=========================
이 앱은 유튜브 영상 링크를 입력받아서, 그 영상의 댓글을
'좋아요가 많은 순'으로 최대 100개까지 가져와서 표로 보여줍니다.
...
4) 받아온 댓글을 좋아요 수 기준으로 정렬해서 화면에 보여줍니다.
"""

import re  # 정규표현식: 링크 문자열에서 영상 ID를 뽑아낼 때 사용합니다.
...
st.set_page_config(page_title="유튜브 댓글 분석 (1단계)", page_icon="💬", layout="wide")
...
st.caption("영상 링크를 넣으면, 좋아요가 많은 순으로 댓글을 최대 100개까지 가져와요.")
